...
function determineBall(a)
{
	...
	if(a==1 && ballType=="Stripe")
	{
		console.log("You hit the wrong ball in.");
		alert("You lose");
	}
	if(a==2 && ballType=="Solid")
	{
		console.log("You hit the wrong ball in.");
		alert("You lose");
	}
...
function onloadHandler()
{
   ...
   function keyDownEvent(e) {
       ...
       if(keyCode == 13) { //num pad enter for debugging
           shoot();
       }
   }
}
